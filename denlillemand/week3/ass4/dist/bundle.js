...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mainlist = __webpack_require__(159);

	var _mainlist2 = _interopRequireDefault(_mainlist);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_mainlist2.default, null), document.getElementById("root"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _namedlist = __webpack_require__(160);

	var _namedlist2 = _interopRequireDefault(_namedlist);

	var _namedlistform = __webpack_require__(162);

	var _namedlistform2 = _interopRequireDefault(_namedlistform);
	...
	var MainList = function (_React$Component) {
		...
		function MainList(props, context) {
			_classCallCheck(this, MainList);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MainList).call(this, props, context));

			_this.state = {};
			_this.swapMessage = _this.swapMessage.bind(_this);
			_this.archiveMessage = _this.archiveMessage.bind(_this);
			_this.onSubmitNamedList = _this.onSubmitNamedList.bind(_this);
		...
		_createClass(MainList, [{
			key: 'archiveMessage',
			value: function archiveMessage(id, currentList, isArchived) {
				...
				this.setState(_defineProperty({}, currentList, mutatedArray));
			}
		}, {
			key: 'swapMessage',
			value: function swapMessage(messageId, destinationList, currentList) {
				var messageIndex = -1;
				...
				if (messageIndex > -1) {
					var copiedCurrentList = this.state[currentList].slice();
					var removedMessage = copiedCurrentList.splice(messageIndex, 1);
					if (removedMessage[0].archived) {
						alert("Cannot remove an archived message");
					} else {
						var _setState2;

						var copiedDestinationList = this.state[destinationList].slice();
						this.setState((_setState2 = {}, _defineProperty(_setState2, currentList, copiedCurrentList), _defineProperty(_setState2, destinationList, copiedDestinationList.concat(removedMessage)), _setState2));
					}
				} else {
			...
			key: 'onSubmitNamedList',
			value: function onSubmitNamedList(name) {
				if (this.state[name]) {
			...
			key: 'onSubmitMessage',
			value: function onSubmitMessage(message, listName) {
				var copiedList = this.state[listName].slice();
				copiedList.push(message);
				this.setState(_defineProperty({}, listName, copiedList));
			}
		}, {
			key: 'deleteMessage',
			value: function deleteMessage(id, listName) {
				var copiedMessages = this.state[listName].slice();
				var messageIdToDelete = -1;
				...
				this.setState(_defineProperty({}, listName, copiedMessages));
			}
		}, {
			key: 'render',
			value: function render() {
				...
				for (var key in this.state) {
					lists.push(_react2.default.createElement(
						'li',
						null,
						_react2.default.createElement(_namedlist2.default, { onSubmitMessage: this.onSubmitMessage, name: key, messages: this.state[key], swap: this.swap, archiveMessage: this.archiveMessage,
							deleteMessage: this.deleteMessage, swapMessage: this.swapMessage })
					));
				}
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_namedlistform2.default, { onSubmitNamedList: this.onSubmitNamedList })
					),
					_react2.default.createElement(
						'div',
						null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NamedList = function (_React$Component) {
				_inherits(NamedList, _React$Component);

				function NamedList(props, context) {
							_classCallCheck(this, NamedList);

							var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NamedList).call(this, props, context));
							...
							_this.onChangeMessageSwapDestinationListName = _this.onChangeMessageSwapDestinationListName.bind(_this);
							_this.onChangeMessage = _this.onChangeMessage.bind(_this);
							_this.onChangeMessageSwapId = _this.onChangeMessageSwapId.bind(_this);
							_this.archiveMessage = _this.archiveMessage.bind(_this);
							_this.deleteMessage = _this.deleteMessage.bind(_this);
							_this.swapMessage = _this.swapMessage.bind(_this);
							return _this;
				...
				_createClass(NamedList, [{
							key: 'swapMessage',
							value: function swapMessage(event) {
							...
							key: 'onChangeMessageSwapDestinationListName',
							value: function onChangeMessageSwapDestinationListName(event) {
										this.setState({
							...
							key: 'onChangeMessageSwapId',
							value: function onChangeMessageSwapId(event) {
							...
							key: 'archiveMessage',
							value: function archiveMessage(id, isArchived) {
							...
							key: 'render',
							value: function render() {
										var sortedMessages = this.props.messages.slice().sort(function (x, y) {
										...
										return _react2.default.createElement(
													...
													_react2.default.createElement('input', { value: this.state.message, onChange: this.onChangeMessage }),
													_react2.default.createElement(
																'button',
													...
													_react2.default.createElement(
																'label',
																null,
																'Name of the list you want to move it to:'
													),
													_react2.default.createElement('input', { value: this.state.messageSwapDestination, onChange: this.onChangeMessageSwapDestinationListName }),
													_react2.default.createElement(
																'label',
																null,
																'Message id:'
													),
													_react2.default.createElement('input', { value: this.state.messageSwapId, onChange: this.onChangeMessageSwapId }),
													_react2.default.createElement(
																'button',
																{ onClick: this.swapMessage },
																'Swap message'
													),
													_react2.default.createElement(
																'h4',
													...
													_react2.default.createElement(
																...
																sortedMessages.map(function (message, index) {
																			return _react2.default.createElement(
																						'li',
																						null,
																						_react2.default.createElement(_message2.default, { archive: this.archiveMessage, message: message, deleteMessage: this.deleteMessage })
																			);
																}.bind(this))
													)
										);
	...
	exports.default = NamedList;

	NamedList.propTypes = {
				messages: _react2.default.PropTypes.object,
				name: _react2.default.PropTypes.string,
				onSubmitMessage: _react2.default.PropTypes.func,
				onDeleteMessage: _react2.default.PropTypes.func,
				archiveMessage: _react2.default.PropTypes.func
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Message = function (_React$Component) {
				...
				function Message(props, context) {
							...
							var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Message).call(this, props, context));

							_this.state = {};
							_this.deleteMessage = _this.deleteMessage.bind(_this);
							_this.archive = _this.archive.bind(_this);
							return _this;
				}

				_createClass(Message, [{
							key: "deleteMessage",
							value: function deleteMessage(event) {
										this.props.deleteMessage(this.props.message.id);
							}
				}, {
							key: "archive",
							value: function archive(event) {
							...
							value: function render() {
										return _react2.default.createElement(
													...
													_react2.default.createElement(
																...
																this.props.message.archived ? "Unarchive" : "Archive"
													),
													_react2.default.createElement(
																"button",
	...
	Message.propTypes = {
				...
				archive: _react2.default.PropTypes.func
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NamedListForm = function (_React$Component) {
				_inherits(NamedListForm, _React$Component);

				function NamedListForm(props, context) {
							_classCallCheck(this, NamedListForm);

							var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NamedListForm).call(this, props, context));
				...
				_createClass(NamedListForm, [{
							...
							value: function render() {
										return _react2.default.createElement(
													"div",
													null,
													_react2.default.createElement("input", { value: this.state.name, onChange: this.onChange }),
													_react2.default.createElement(
																"button",
				...
				return NamedListForm;
	}(_react2.default.Component);

	exports.default = NamedListForm;
