...
var assetpath = function(filename) { return 'examples/assets/' + filename; };

var MeshFactory = React.createFactory(ReactTHREE.Mesh);
var Cupcake = require('objects/cube.js');
//
// Cupcake component is two cube meshes textured with cupcake textures
//

var boxgeometry = new THREE.BoxGeometry( 200,200,200);
var cupcakematerial = new THREE.MeshBasicMaterial( { color: 0x00ff00 } );
