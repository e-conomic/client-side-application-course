...
/***/ function(module, exports, __webpack_require__) {
	...
	var AssignmentApp = __webpack_require__(159);

	ReactDOM.render(React.createElement(AssignmentApp, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OnPressingEnterMixin = __webpack_require__(160);
	var GeneratedList = __webpack_require__(161);

	var AssignmentApp = React.createClass({
		displayName: 'AssignmentApp',

		mixins: [OnPressingEnterMixin],
		...
		submitNewList: function submitNewList() {
		...
		submitMessage: function submitMessage(listKey, msgText) {
			if (msgText === '') {
				return;
			};
		...
		deleteMessage: function deleteMessage(listKey, msgKey) {
			var updatedGeneratedLists = JSON.parse(JSON.stringify(this.state.generatedLists));
			var generatedList = this.getGeneratedListFromArray(listKey, updatedGeneratedLists);
		...
		archiveMessage: function archiveMessage(listKey, msgKey) {
			var updatedGeneratedLists = JSON.parse(JSON.stringify(this.state.generatedLists));
			var generatedList = this.getGeneratedListFromArray(listKey, updatedGeneratedLists);
			var msgToArchive;
		...
		extractMessage: function extractMessage(listKey, msgKey) {
			var updatedGeneratedLists = JSON.parse(JSON.stringify(this.state.generatedLists));
			var generatedList = this.getGeneratedListFromArray(listKey, updatedGeneratedLists);
			var msgToExtract;
		...
		moveMessage: function moveMessage(msg, oldListKey, targetListKey) {
			if (oldListKey == undefined || targetListKey == undefined || msg == undefined) {
				return;
			}
			var updatedGeneratedLists = JSON.parse(JSON.stringify(this.state.generatedLists));
		...
		getGeneratedListFromArray: function getGeneratedListFromArray(listKey, clonedList) {
		...
		isValidMessage: function isValidMessage(msg) {
			if (msg.length <= 200) {
				return true;
			}
			return false;
		...
		render: function render() {
			var createLists = function createLists(generatedList) {
				return React.createElement(GeneratedList, {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement('input', { onChange: this.onChange, value: this.state.listName, onKeyDown: this.onPressingEnter }),
					React.createElement('input', { type: 'button', value: 'Submit', onClick: this.submitNewList })
				),
				React.createElement(
					'div',
					null,
...
/***/ function(module, exports) {
	...
	var OnPressingEnterMixin = {
		onPressingEnter: function onPressingEnter(e) {
			if (e.keyCode == 13) {
				this.onClick();
			};
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OnPressingEnterMixin = __webpack_require__(160);
	var ArchiveList = __webpack_require__(162);
	var MessageList = __webpack_require__(164);

	var GeneratedList = React.createClass({
		displayName: 'GeneratedList',
		...
		onMoveMessage: function onMoveMessage(msg, targetListKey) {
			this.props.onMoveMessage(msg, this.props.data.index, targetListKey);
		},

		onDeleteMessage: function onDeleteMessage(msgKey) {
			this.props.onDeleteMessage(this.props.data.index, msgKey);
		},

		onArchiveMessage: function onArchiveMessage(msgKey) {
			this.props.onArchiveMessage(this.props.data.index, msgKey);
		},

		onExtractMessage: function onExtractMessage(msgKey) {
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement('input', { type: 'text', onChange: this.onChange, value: this.state.text, onKeyDown: this.onPressingEnter }),
				React.createElement('input', { type: 'button', value: 'add', onClick: this.onClick }),
				...
				React.createElement(ArchiveList, { archivedList: this.props.data.archivedList, onExtractMessage: this.onExtractMessage })
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ArchiveList = React.createClass({
		...
		handleMessageExtract: function handleMessageExtract(key) {
			...
			var createMessage = function createMessage(msg) {
				return React.createElement(
					...
					React.createElement(
						'td',
						null,
						React.createElement(Message, { text: msg.text })
					),
					React.createElement(
						'td',
						null,
						React.createElement('input', { type: 'button', value: 'Extract', onClick: this.handleMessageExtract.bind(this, msg.index) })
					)
				);
			};
			return React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Message = __webpack_require__(163);
	var GeneratedListDropDown = __webpack_require__(165);

	var MessageList = React.createClass({
		displayName: 'MessageList',


		handleMessageDelete: function handleMessageDelete(key) {
			this.props.onDeleteMessage(key);
		},

		handleMessageArchive: function handleMessageArchive(key) {
			...
			var createMessage = function createMessage(msg) {
				return React.createElement(
					...
					React.createElement(
						'td',
						null,
						React.createElement(GeneratedListDropDown, {
							generatedLists: this.props.generatedLists,
							myListKey: this.props.myListKey,
							msg: msg,
							onMoveMessage: this.onMoveMessage
					...
					React.createElement(
						'td',
						null,
						React.createElement('input', { type: 'button', value: 'X', onClick: this.handleMessageDelete.bind(this, msg.index) })
					),
					React.createElement(
						'td',
						null,
						React.createElement('input', { type: 'button', value: 'Archive', onClick: this.handleMessageArchive.bind(this, msg.index) })
					)
				);
			};
			return React.createElement(
				...
				React.createElement(
					'tbody',
					null,
					this.props.messageList.map(createMessage, this)
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GeneratedListDropDown = React.createClass({
		displayName: 'GeneratedListDropDown',
		...
		handleMessageMove: function handleMessageMove(msg, targetListKey) {
			this.props.onMoveMessage(msg, targetListKey);
		},
		...
		render: function render() {
			var createDropdownList = function createDropdownList(list) {
				if (this.props.myListKey == list.index) {
					return;
				}
				return React.createElement(
					'option',
					{ key: list.index, value: list.index },
					list.name
				);
			};
			return React.createElement(
				...
				React.createElement('option', { key: 'null', value: '-' }),
