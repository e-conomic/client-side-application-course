describe('Message Store', function() {
	...
	it('should create and push a message from the dispatched action', sinon.test(function() {
	...
	it('should return all messages from a specified list', sinon.test(function() {
		Dispatcher.dispatch(createMessage);
	...
	it('should return a list of alphabetically-ordered messages', sinon.test(function() {
