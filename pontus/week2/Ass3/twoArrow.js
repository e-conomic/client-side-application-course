...
class Wrapper extends React.Component { 
	...
	render() {
		...
		for (let list in this.state.lists) { 
			lists.push(
					<NamedList lists={this.state.lists} 
			...
			for (let key in this.props.list) { 
				...
				if ( this.props.lists[this.props.listID][key].isArchived) {  
					archivedMessages.push(
							<Message listID={this.props.listID} 
							moveMsg={this.props.moveMsg.bind(this)} 
							msgID={key} 
							lists={this.props.lists} 
							archiveMsg={this.props.archiveMsg} 
							deleteMsg={this.props.deleteMsg} 
							message={this.props.list[key].text}
					/>);
				}
				else { 
					nonArchivedMessages.push(
							<Message listID={this.props.listID} 
							moveMsg={this.props.moveMsg.bind(this)} 
							msgID={key} 
							lists={this.props.lists} 
